...
--- Updates installed plugins via vim.pack: fetches updates and opens the
--- native confirmation buffer (apply with `:write`, discard with `:q`), then
--- restart to use the new code. Optional args restrict the update to the named
--- plugins.
